...
{
    public partial class SalaryChanges : Form
    {
        ...
        private void SalaryChanges_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void dgvPendingBonus_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
        ...
        private void dgvPendingBonus_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
        ...
        private void dgvPendingBonus_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
        ...
        private void checkSalaryChange()
        {
            if (nudPercent.Value == 0)
            {
                throw new DataException("Percentage of salary increase must be greater than 0");
            }
